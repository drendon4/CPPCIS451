            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="bstore-breadcrumb">
                        ...
                        <a  href="Category.aspx?MainCategoryID=<%# Eval("ID")%>"><%# Eval("CategoryName")%></a>
                    ...
                    <%--              <div class="right-all-product">
                      ...
                      <div class="product-category-header">
                        ...
                        <div class="product-category-title">
                            ...
                            <h1>
                                <span class="cat-name"><%# Eval("CategoryName")%></span>
                        ...
                        <div class="product-shooting-area">
                            <div class="product-shooting-bar">
                                ...
                                <div class="view-systeam">
                                    ...
                                    <ul>
                                        <li class="active"><a href="shop-gird.html"><i class="fa fa-th-large"></i></a>
                                            <br />
                                            Grid</li>
                                        <li><a href="shop-list.html"><i class="fa fa-th-list"></i></a>
                                            <br />
                                            List</li>
                                    </ul>
                                </div>
